        ...
        <div id="itemAddedToCartPanelBackground">
            <div id="itemAddedToCartPanel">
                ...
                <div id="cartPanelNavButtons">
                    <button className="cartPanelButton" id="cartPanelCartButton" onClick={() => navigate("/cart")}>Go to cart</button>
                    <button className="cartPanelButton" id="cartPanelCheckoutButton" onClick={() => navigate("/checkout")}>Go to checkout</button>
                </div>
